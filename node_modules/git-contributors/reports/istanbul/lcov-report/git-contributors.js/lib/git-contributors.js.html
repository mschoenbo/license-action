...
<html lang="en">
<head>
    <title>Code coverage report for git-contributors.js/lib/git-contributors.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">git-contributors.js/lib/git-contributors.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">71.74% <small>(33 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">git-contributors.js/lib/</a> &#187; git-contributors.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isObject(opts)) {
<span class="cstat-no" title="statement not covered" >    options = _.merge(options, opts);</span>
  }
...
var __exec = function (err, stdout, cb) {
  'use strict';
  <span class="missing-if-branch" title="if path not taken" >I</span>if (err) { <span class="cstat-no" title="statement not covered" >return cb(err, null); </span>}
&nbsp;
  var list,
...
&nbsp;
&nbsp;
GitContributors.prototype.parse = <span class="fstat-no" title="function not covered" >function parseOpts (argv, version) {</span>
  'use strict';
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var target = program.args[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.list(target, <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed May 21 2014 20:56:51 GMT+0200 (CEST)</div>
</div>
